...
('project.location', '', 'Место расположения проекта', 'Путь к корневой папке проекта. Только для чтения.', 'Общие', 'string', 'readonly'),
('project.name', 'Мой проект', 'Название проекта', 'Общее название проекта или произведения.', 'Общие', 'string', 'readonly'),
