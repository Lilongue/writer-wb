...
*   **Реализация и рефакторинг функции экспорта рукописи:**
    ...
    *   Проведен рефакторинг `ManuscriptService`: асинхронные операции в циклах переписаны с использованием `Promise.all` для повышения производительности, а вспомогательные методы сделаны статическими для улучшения чистоты кода.

---

## 22 ноября 2025 г

* Актуализация планов разработки: синхронизация `features.md` с `alpha-plan.md` и реорганизация `alpha-plan.md` в пошаговый план `alpha-plan_revised.md`.
