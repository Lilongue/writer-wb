...
|   ❌   | **Настраиваемая иерархия и типы элементов повествования**          | (Усложнение). Позволяет в настройках проекта определять типы элементов («Пролог», «Акт») и задавать правила их вложенности (например, Книга -> Часть -> Глава). |
