...
Если вы откроете проект, который был создан в более старой версии Writer World Builder, приложение обнаружит это и предложит вам обновить его.

**Как это работает:**

1. При открытии устаревшего проекта вы увидите уведомление об этом.
2. В меню "Файл" станет активным пункт **"Обновить структуру проекта..."**.
3. Выберите этот пункт меню. Появится диалоговое окно, которое попросит вас подтвердить обновление и сообщит, что будет создана резервная копия.
4. После вашего согласия приложение автоматически обновит проект до последней версии и перезагрузит его.

Этот механизм гарантирует, что ваши проекты всегда будут совместимы с последней версией приложения, а ваши данные останутся в безопасности благодаря автоматическому резервному копированию.
