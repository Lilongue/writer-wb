...
WriterWorldBuilder информирует пользователя о важных событиях, успехах или ошибках с помощью уведомлений. Например, если вы попытаетесь открыть настройки проекта, когда ни один проект не открыт, появится предупреждающее сообщение, указывающее на причину невозможности выполнения действия.
