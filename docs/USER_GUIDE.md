...
4. WriterWorldBuilder автоматически обнаружит эти файлы и отобразит их в виде списка в новой сворачиваемой панели **"Дополнительные файлы"**, которая появится над блоком "Связи".
