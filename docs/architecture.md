...
* `TemplateService.ts`: **Менеджер шаблонов объектов мира.**
  * **Ответственность:** Бизнес-логика, связанная с управлением шаблонами объектов мира (CRUD, архивация, переименование), а также управлением схемой их пользовательских полей.
